...
```
https://github.com/DuyOhze119/gameup-unity-template.git?path=Assets/GameUpCore#main
```
...
{
  "dependencies": {
    "com.gameup.core": "https://github.com/DuyOhze119/gameup-unity-template.git?path=Assets/GameUpCore#main"
  }
}
```
