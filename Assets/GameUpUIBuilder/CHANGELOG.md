...
- Preview ảnh demo trong cửa sổ: đọc thẳng file gốc (không bị Max Size/nén của import settings), đúng tỉ lệ, chỉnh chiều cao; vẽ khung sprite đã định vị, rê chuột xem tên, bấm để chọn. Overlay Scene View dùng chung texture này. Cửa sổ tự tải lại khi `locate.json`/`spec.json` đổi từ bên ngoài.
